...
import { handleApplicationCreated } from "../../src/handlers/v0.8/dapp"
import { createApplicationCreatedEventV08, txTimestamp } from "../utils"
...
describe("Dapp v0.8", () => {
    describe("On application-created Event", () => {
        ...
        test("should create factory and dapp after handling event", () => {
            ...
            const event = createApplicationCreatedEventV08(
                timestamp,
                factoryAddress,
                appAddress
            )
        ...
        test("should update dashboard with overall status about factories and dapps", () => {
            ...
            let evt = createApplicationCreatedEventV08(
                timestamp,
                factoryAddress,
                appAddressOne
            )
            ...
            let eventTwo = createApplicationCreatedEventV08(
                timestamp,
                factoryAddress,
                appAddressTwo
            )
